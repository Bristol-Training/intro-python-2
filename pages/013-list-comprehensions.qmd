...
You can see that the output has exactly the same answer but was one in one line instead of four. You might recognise some familiar features in there but they're not in the usual order. Let's break it apart, step-by-step:
