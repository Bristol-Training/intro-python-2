...
The functionality provided by the Standard Library is provided in a series of *modules*, each of which serves a particular purpose. The modules in the Standard Library are always installed in any version of Python you have. Note that even though they are always accessible, they do not count as "built-in" in Python terms, that means something which you can use without having to access any extra modules.
