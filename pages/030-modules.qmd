...
We will need to create a new file to hold the function. Let's call it `convert.py`. Make
sure this is in the same directory as your notebook. A `.py` file is a file containing
Python code. Let's put the function we wrote in the last section into that file:
...
::: {.callout-warning title="Importing your own modules in notebooks"}
...
We'll cover move on how to write tests for your Python modules in the [Best Practices in Software Engineering](https://bristol-training.github.io/best-practices-software-engineering/) course but for now, this round-trip will suffice.
