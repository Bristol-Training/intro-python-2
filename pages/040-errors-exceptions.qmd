...
Here we will use the module `convert.py`. **Don't forget to restart your notebook kernel** so that it forgets any previous version of `convert.py` you may have loaded.
...
weight_in_grams = ounces_to_grams(-30)
print(f"{weight_in_grams} g")
```
