...
Python 3.7 (release June 2018) introduced a new feature called *data classes* which aim to simplify the common tasks of creating classes. If you can rely on having this version or newer of Python available then consider [looking into using data classes](aside_dataclasses.ipynb).
