...
Welcome to this second course on Python programming! This course builds upon [Introduction to Python 1](https://bristol-training.github.io/intro-python-1/) and delves deeper into working with advanced data structures, write functions, explore modules, and how to handle errors and exceptions. Get ready to take your Python skills to the next level!

For the purpose of this course we will be using a free tool called JupyterLab which provides you with a local editor and Python terminal in your web browser. Set up instructions can be found [here](./pages/001-workspace-setup.qmd).
...
In this documentation, any time that we see a small snippet of Python code, we'll see it written in a grey box like the following:
...
Lastly, we will highlight important points using green boxes like this one:
